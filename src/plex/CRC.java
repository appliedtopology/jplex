...
//  ***************************************************************************
// 
//  CRC hash functions for various types of integer and string data. 
// 
//  $Id$
// 
...
public final class CRC {
  ...
  private static final long[] hash64tab0 = new long[]
  ...
  private static final long[] hash64tab1 = new long[]
  ...
  private static final int[] hash32tab0 = new int[]
   ...
   */
  private static final int update32l(long b, int hcode, int[] tbl) {
   ...
   * @return     Updated int value of CRC calculation.
   */
  private static final int update32(byte b, int hcode, int[] tbl) {
   ...
   * @return     Updated int value of CRC calculation.
   */
  private static final int update32(short s, int hcode, int[] tbl) {
   ...
   * @return     Updated int value of CRC calculation.
   */
  private static final int update32(int i, int hcode, int[] tbl) {
   ...
   * @return     Updated int value of CRC calculation.
   */
  private static final int update32(long l, int hcode, int[] tbl) {
   ...
   */
  private static final long update64l(long b, long hcode, long[] tbl) {
   ...
   * @return     Updated long value of CRC calculation.
   */
  private static final long update64(byte b, long hcode, long[] tbl) {
   ...
   * @return     Updated long value of CRC calculation.
   */
  private static final long update64(short s, long hcode, long[] tbl) {
   ...
   * @return     Updated long value of CRC calculation.
   */
  private static final long update64(int i, long hcode, long[] tbl) {
   ...
   * @return     Updated long value of CRC calculation.
   */
  private static final long update64(long l, long hcode, long[] tbl) {
   ...
   */
  public static final long hash64(byte[] v) {
    long hcode = 0L;
    for(byte x : v) {
   ...
   * @return     Long containing CRC hash of array.
   */
  public static final long hash64(short[] v) {
    long hcode = 0L;
    for(short x : v) {
      hcode = update64(x, hcode, hash64tab1);
    }
   ...
   */
  public static final long update_hash(int x, long hcode) {
   ...
   * @return     Long which is the updated hcode for x.
   */
  public static final long update_hash(long x, long hcode) {
    return update64(x, hcode, hash64tab1);
  }
   ...
   * @return     Long containing CRC hash of array.
   */
  public static final long hash64(int[] v) {
    long hcode = 0L;
    for(int x : v) {
      hcode = update64(x, hcode, hash64tab1);
    }
   ...
   */
  public static final long hash64(float[] v) {
    long hcode = 0L;
    for(float xf : v) {
   ...
   * @return     Long containing CRC hash of array.
   */
  public static final long hash64(long[] v) {
    long hcode = 0L;
    for(long x : v) {
      hcode = update64(x, hcode, hash64tab1);
    }
   ...
   * @return     CRC hash of array.
   */
  public static final long hash64(double[] v) {
    long hcode = 0L;
    for(double xd : v) {
   ...
   */
  public static final int hash32(byte[] v) {
    int hcode = 0;
    for(byte x : v) {
   ...
   * @return     Int containing CRC hash of array.
   */
  public static final int hash32(short[] v) {
    int hcode = 0;
    for(short x : v) {
      hcode = update32(x, hcode, hash32tab0);
    }
   ...
   * @return     Int containing CRC hash of array.
   */
  public static final int hash32(int[] v) {
    int hcode = 0;
    for(int x : v) {
      hcode = update32(x, hcode, hash32tab0);
    }
   ...
   * @return     Int containing CRC hash of array.
   */
  public static final int hash32(long[] v) {
    int hcode = 0;
    for(long x : v) {
      hcode = update32(x, hcode, hash32tab0);
    }
   ...
   * @return     Int containing CRC hash of array.
   */
  public static final int hash32(double[] v) {
    int hcode = 0;
    for(double xd : v) {
      long x = Double.doubleToRawLongBits(xd);
      hcode = update32(x, hcode, hash32tab0);
   ...
   */
  public static final int hash32(double[][] A, int rows, int cols) {
    int hcode = 0;
   ...
   */
  public static final long hash64(long x, long initial) {
    long hcode = initial;
    hcode = update64(x, hcode, hash64tab1);
    return hcode;
  }
   ...
   */
  public static final int hash32(long x, int initial) {
    int hcode = initial;
    hcode = update32(x, hcode, hash32tab0);
    return hcode;
  }
