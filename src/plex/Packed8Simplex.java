...
public final class Packed8Simplex extends Simplex {
  ...
  private static final long DIM_6_MASK = ~((long) MAX_8_INDEX);
  ...
  private static final boolean check_8_vertices(int[] v) {
    if (v.length <= 6)
      return false;
  ...
  private static final void assert_8_vertices(int[] v) {
  ...
  private Packed8Simplex(long bits_lo_val, long bits_lo_mid_val,
  ...
  private Packed8Simplex(int v1, int v2, int v3, int v4, int v5, int v6, 
                         int v7) {
  ...
  private final int compareTo(Packed8Simplex s) {
