...
import java.util.*;
// Share some "private" functions defined in WitnessStream.
...
public final class LazyWitnessStream extends SimplexStream {
  ...
  // is initialized.
  private final SimplexStream.Stack find_simplices(double delta, double R_max, int nu, 
    ...
    // Final repository for the elements of the LazyWitness complex.
    ...
    // needed.
    {
      ...
      // complex. 
      {
        double[] i_cache = (D == null)?new double[N+1]:null;
