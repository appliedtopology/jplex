...
public final class Persistence {
  ...
  private final Chain removePivotRows(Simplex sigma) {
   ...
   * homology.
   */
  public final PersistenceInterval.Float[] computeIntervals(SimplexStream stream) {
   ...
   */
  public final PersistenceInterval[] computeRawIntervals (SimplexStream stream, 
                                                          boolean preserveStream,
                                                          int prime) {
