...
abstract public class Simplex implements Comparable<Simplex> {
   ...
   *
   */    
  public final Chain setChain (Chain c) {
    if (_chain != null)
   ...
   */
  public static final Simplex getSimplex (int[] vertices) {
   ...
   * @return     A simplex for that set of vertices.
   */
  public static final Simplex getSimplex (int[] vertices, int findex) {
   ...
   * @return     A simplex for that set of vertices.
   */
  public static final Simplex getSimplexPresorted (int[] vertices) {
    if (vertices.length <= 2)
   ...
   * @return     A simplex for that set of vertices.
   */
  public static final Simplex getSimplexPresorted(int[] vertices, int findex) {
   ...
   */
  public static final Simplex makeEdge (int v1, int v2, int findex) {
   ...
   */
  public static final Simplex makePoint (int v, int findex) {
   ...
   * @return     The new simplex.
   */
  public final Simplex addVertex (int v, int f) {
   ...
   */
  public static final int[] vertex_sort (int[] vertices) {
   ...
   */
  public static final double[] dist_sort (double[] distances) {
   ...
   */
  public static final int[] simplex_reverse_sort (int[] vertices) {
   ...
   * @return     [face0, face1, ...]
   */
  abstract public Simplex[] boundary();
