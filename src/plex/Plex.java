...
//  ***************************************************************************
// 
//  Entry points for Plex. And catchall for utility code, for now.
// 
//  $Id$
// 
...
public class Plex {
  ...
  public static final int intersection_count(int[] v1, int[] v2) {
   ...
   *
   */
  public final static int sorted_intersection_count(int[] v1, int[] v2) {
    int count = 0;
  ...
  private static boolean is_permutation (int[] perm) {
  ...
  static final int comparePtArrays (int[] pts1, int[] pts2) {
  ...
  static final boolean equalPtArrays (int[] pts1, int[] pts2) {
    if (pts1 == pts2)
      return true;
  ...
  private static final int firstSmallerPtIndex (int arg, int lo, int[] pts) {
    // Binary search.
    int hi = pts.length - 1;
  ...
  private static final boolean ptArrayIsSubset (int[] ipts, int[] jpts) {
    int j = 0;
  ...
  public static class BettiNumbers {
    ...
    static private boolean init_okay(int[] init) {
    ...
    // unused
    private BettiNumbers() { numbers = null; }
  ...
  */
  ...
  private static final boolean d_okay(double[][] d) {
  ...
  private static PersistenceInterval.Float[] filter_pintervals
  ...
  private static double normalizeUpperBound(double arg) {
    if (arg < 1.0) {
      double current = .1;
      while (current > arg) {
        current *= .1;
  ...
  // printing.
  private static double[][][] printable_intervals(PersistenceInterval[] arg) {
  ...
  private static boolean useMessageWindow = false;
